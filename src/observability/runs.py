    ...
    try:
        return conn.execute(
            ...
            SELECT run_id, run_date, status, total_latency_ms,
                   ...
                   same_day_match_candidates, same_day_match_accepts,
                   matching_deterministic_decisions, matching_mini_decisions,
                   matching_fail_closed_decisions, matching_ambiguous_cases,
