...
def pipeline_report(run_id):
    ...
    lines = [
        ...
        f"Same-day candidates:    {row['same_day_match_candidates'] or 0}",
        f"Same-day accepted:      {row['same_day_match_accepts'] or 0}",
        f"Deterministic decisions:{row['matching_deterministic_decisions'] or 0:>7}",
        f"Mini decisions:         {row['matching_mini_decisions'] or 0}",
        f"Fail-closed decisions:  {row['matching_fail_closed_decisions'] or 0}",
        f"Ambiguous matches:      {row['matching_ambiguous_cases'] or 0}",
        f"Arc label promotions:   {row['story_arc_label_promotions'] or 0}",
